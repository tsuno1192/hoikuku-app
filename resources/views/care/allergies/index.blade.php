<x-app-layout>
    <x-slot name="header"><h2 class="font-semibold text-xl text-gray-800 leading-tight">アレルギー・配膳ガード</h2></x-slot>
    <div class="py-8">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <form method="POST" action="{{ route('allergies.store') }}" class="bg-white p-6 rounded shadow-sm grid md:grid-cols-4 gap-3">
                @csrf
                ...
                <input name="allergen" required placeholder="アレルゲン（卵など）" class="border-gray-300 rounded-md">
                ...
                <button class="bg-slate-900 text-white rounded-md text-sm">登録</button>
            </form>
